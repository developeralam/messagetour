...
class Hotel extends Component
{
    ...
    {
        return <<<SVG
            <svg width="{$this->width}" height="{$this->height}" viewBox="0 0 1024 1024" class="icon"
                ...
                <path d="M179 769l-33-7 33-8 7-32 8 32 32 8-32 7-8 33-7-33zM140 533l-15-3 15-4 3-14 4 14 14 4-14 3-4 15-3-15z"
                    fill="#FDCD60" />
                <path d="M828 793a25 25 0 1 1 25-25 25 25 0 0 1-25 25z m0-36a10 10 0 1 0 10 10 10 10 0 0 0-10-10z"
                    fill="#5546CB" />
                <path
