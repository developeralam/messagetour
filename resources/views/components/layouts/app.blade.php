...
<head>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/63be688fc2f1ac1e202cd2ab/1gmfsgt70';
            s1.charset = 'UTF-8';
...
<body>
    <span id="top"></span>
    <div x-cloak x-data="{ showButton: false }" @scroll.window="showButton = window.scrollY > 100">
        <a href="#top" id="moveToTop" x-show="showButton"
            class="z-50 fixed animate-bounce left-5 bottom-20 h-[45px] w-[50px] rounded-md flex items-center justify-center bg-green-500 border-[10px] border-green-500 hover:bg-green-600 hover:border-green-600">
            <x-icon name="fas.arrow-up" class="text-white" />
        </a>
    </div>
    <!-- TAGLINE START-->
                ...
                <div class="flex items-center justify-between">
                    <ul class="list-none flex xl:items-center gap-x-3 gap-y-1 flex-col md:flex-row">
                        <li class="inline-flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                class="feather feather-clock text-green-500 size-4">
                        ...
                        <li class="inline-flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="feather feather-map-pin text-green-500 size-4">
                                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg>
                            <span class="ms-2 text-slate-300 text-xs md:text-sm">{{ $globalSettings->address ?? '' }}</span>
                        </li>
                    </ul>
                    ...
                    <ul class="list-none flex xl:items-center gap-x-3 gap-y-1 flex-col md:flex-row">
                        <li class="inline-flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="feather feather-mail text-green-500 size-4">
                        ...
                        <li class="inline-flex items-center self-end">
                            <ul class="list-none flex items-center">
                                <li class="inline-flex mb-0"><a href="{{ $globalSettings->facebook_url ?? '' }}"
                                        class="text-slate-300 hover:text-green-500"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook size-4 align-middle"
                                            title="facebook">
                                ...
                                <li class="inline-flex ms-2 mb-0"><a href="{{ $globalSettings->instagram_url ?? '' }}"
                                        class="text-slate-300 hover:text-green-500"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram size-4 align-middle"
                                            title="instagram">
                                ...
                                <li class="inline-flex ms-2 mb-0"><a href="{{ $globalSettings->twitter_url ?? '' }}"
                                        class="text-slate-300 hover:text-green-500"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter size-4 align-middle"
                                            title="twitter">
                                            <path
                                ...
                                <li class="inline-flex ms-2 mb-0"><a href="{{ $globalSettings->phone ?? '' }}"
                                        class="text-slate-300 hover:text-green-500"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone size-4 align-middle"
                                            title="phone">
                                            <path
    ...
    <nav x-data="{ isOpen: false }" class="bg-white shadow-lg sticky top-0 z-30 border-b border-gray-100">
        <div class="w-11/12 md:max-w-6xl mx-auto flex items-center justify-between py-1 md:py-3">
            ...
            <a href="/" class="flex items-center">
                <img src="{{ $globalSettings->logo_link ?? '/logo.png' }}" class="h-9 md:h-10 lg:h-12 rounded-lg shadow-none" alt=" Logo" />
            </a>
                ...
                <ul class="flex gap-2 md:gap-3 lg:gap-4 items-center font-semibold text-gray-600">
                    ...
                    <li>
                        <a @click="$dispatch('openModel')"
                            class="relative px-2 md:px-1.5 lg:px-3 py-1.5 md:py-2 rounded-lg hover:bg-green-50 hover:text-green-600 hover:cursor-pointer transition text-sm md:text-base lg:text-[15px] {{ request()->is('contact-us') ? 'text-green-600 font-bold bg-green-50' : '' }}">
                            Corporate Query
                        </a>
                    </li>
                </ul>
            ...
            <div class="flex items-center gap-2 md:gap-3 lg:gap-4">
                @auth
                    <div class="relative" x-data="{ userMenu: false }">
                        <button @click="userMenu = !userMenu"
                            ...
                            @endphp
                            <img src="{{ $image ?? '/empty-user.jpg' }}" class="h-8 w-8 md:h-9 md:w-9 rounded-full shadow" alt="User" />
                            <svg class="w-4 h-4 text-gray-600 group-hover:text-green-600 transition" fill="none" stroke="currentColor"
                                stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="userMenu" @click.away="userMenu = false" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                            x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 scale-100"
                            x-transition:leave-end="opacity-0 scale-95"
                            class="absolute right-0 mt-2 w-44 bg-white rounded-lg shadow-lg py-2 z-50 border border-gray-100" style="display: none;">
                ...
                @else
                    ...
                    <a href="/customer/login"
                        ...
                        <svg class="w-4 h-4 text-green-600 hover:text-green-700 opacity-80" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                ...
                <button @click="isOpen = !isOpen"
                    ...
                    <svg x-show="!isOpen" class="w-7 h-7 text-green-600" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
        ...
        <!-- Mobile Nav Overlay -->
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-8"
            ...
            <button @click="isOpen = !isOpen"
                ...
                <svg x-show="isOpen" class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>

            <a href="/" class="mb-6 flex items-center gap-2" @click="isOpen = false">
                <img src="{{ $globalSettings->logo_link ?? '/logo.png' }}" class="h-12 rounded-lg shadow-none" alt="Logo" />
            </a>
            <ul class="flex flex-col items-center w-full gap-1">
                ...
                <li>
                    <a @click="$dispatch('openModel'); isOpen = false"
                        class="block w-full text-center py-3 px-6 rounded-lg font-bold text-sm text-gray-700 hover:bg-green-100 hover:cursor-pointer hover:text-green-600 transition {{ request()->is('contact-us') ? 'bg-green-50 text-green-600' : '' }}">
                        Corporate Query
                    </a>
                </li>
                @guest
    ...
    <div x-data="{
        ...
        slideCount: 3,
        images: [
            '{{ asset('cover-photo/tufkuuZnlgrAXrhv7U8Ovh2AgYtpQK7z.png') }}',
            '{{ asset('cover-photo/Nf2PiA0cHUK-ntuZbo4YlbYy8W1Z9S2R.png') }}',
            '{{ asset('cover-photo/NESgNXCC9ZqO11ts-b-cRAZvzhlnPoUy.jpg') }}'
        ]
    }" class="relative bg-cover bg-center overflow-hidden z-0" x-init="setInterval(() => {
        activeSlide = activeSlide < slideCount ? activeSlide + 1 : 1
    }, 5800)" x-cloak>

        <!-- Loop through images dynamically -->
        <template x-for="(image, index) in images" :key="index">
            <div x-show="activeSlide === index + 1" x-transition:enter="transition-opacity duration-[2000ms] ease-in-out"
                x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                x-transition:leave="transition-opacity duration-[2000ms] ease-in-out" x-transition:leave-start="opacity-100"
        ...
        <!-- Hero Start -->
        <section class="relative py-8 md:py-12 xl:py-24 md:my-5">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-6 md:mb-8 lg:mb-12">
                    <h1 class="font-bold text-white leading-normal text-2xl md:text-4xl lg:text-5xl shining-effect-cover">
                        Let The Journey Begin With <span class="italic">{{ $globalSettings->application_name ?? 'FLYVALY' }}</span>
                    </h1>
                    <p class="text-white text-xs md:text-lg max-w-xl mx-auto font-semibold">Find Flights, Hotels, Tour,
                        Travel
                        Product, Car, Visa & Holidays</p>
                </div>
                ...
                <div class="col-span-12">
                    <div class="lg:pt-10 pb-5 px-0">
                        <div class="grid md:grid-cols-12 grid-cols-1 gap-6">
                            ...
                            <div class="lg:col-span-2 md:col-span-12 text-center">
                                <a href="/" class="text-[22px] focus:outline-none">
                                    <img class="w-auto md:mx-auto lg:mx-0" src="{{ $globalSettings->logo_link ?? '/logo.png' }}">
                                </a>
                            ...
                            <div class="md:col-span-7 grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <h5 class="tracking-[1px] text-gray-100 mt-4 text-sm lg:text-base whitespace-nowrap">
                                    ...
                                    <ul class="list-none mt-2 flex flex-wrap md:flex-nowrap gap-1 md:gap-0.5 lg:gap-1">
                                        <li class="inline"><a href="https://1.envato.market/travosy" target="_blank"
                                                class="size-5 md:size-7 lg:size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-green-500 rounded-md hover:bg-green-500 hover:text-white text-slate-300"><svg
                                                    ...
                                                    stroke-linejoin="round" class="feather feather-shopping-cart size-3 md:size-4 align-middle"
                                                    title="Buy Now">
                                        ...
                                        <li class="inline"><a href="https://dribbble.com/shreethemes" target="_blank"
                                                class="size-5 md:size-7 lg:size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-green-500 rounded-md hover:bg-green-500 hover:text-white text-slate-300"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-dribbble size-3 md:size-4 align-middle"
                                                    title="dribbble">
                                                    <circle cx="12" cy="12" r="10"></circle>
                                                    <path
                                        ...
                                        <li class="inline"><a href="{{ $globalSettings->linkedin_url ?? '' }}" target="_blank"
                                                class="size-5 md:size-7 lg:size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-green-500 rounded-md hover:bg-green-500 hover:text-white text-slate-300"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-linkedin size-3 md:size-4 align-middle"
                                                    title="Linkedin">
                                        ...
                                        <li class="inline"><a href="{{ $globalSettings->facebook_url ?? '' }}" target="_blank"
                                                class="size-5 md:size-7 lg:size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-green-500 rounded-md hover:bg-green-500 hover:text-white text-slate-300"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-facebook size-3 md:size-4 align-middle"
                                                    title="facebook">
                                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z">
                                                    </path>
                                                </svg></a></li>
                                        <li class="inline"><a href="{{ $globalSettings->instagram_url ?? '' }}" target="_blank"
                                                class="size-5 md:size-7 lg:size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-green-500 rounded-md hover:bg-green-500 hover:text-white text-slate-300"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-instagram size-3 md:size-4 align-middle"
                                                    title="instagram">
                                                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                                        ...
                                        <li class="inline">
                                            <a href="{{ $globalSettings->twitter_url ?? '' }}" target="_blank"
                                                class="size-5 md:size-7 lg:size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-green-500 rounded-md hover:bg-green-500 hover:text-white text-slate-300"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" class="feather feather-twitter size-3 md:size-4 align-middle"
                                                    title="twitter">
                                                    <path
                                                        d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z">
                                                    </path>
                        ...
                        <div class="flex justify-center items-center mt-2">
                            <p class="text-gray-300 text-xs sm:text-base">Copyright &copy; {{ date('Y') }}. <a href="/"
    ...
    <script>
        $(document).ready(function() {
            ...
            owl.owlCarousel({
                ...
                autoplayTimeout: 2000, // Set autoplay interval to 2000ms (2 seconds)
                autoplayHoverPause: true, // Pause autoplay on hover
                smartSpeed: 800, // Add smooth transition speed
                responsive: {
                    0: {
                        items: 1
                    },
            ...
            // Ensure autoplay starts after the carousel is initialized
    ...
    <script>
        $(document).ready(function() {
            if (window.innerWidth < 1280) { // Only apply carousel below xl
    ...
    <script>
        $(document).ready(function() {
            const offerCount = parseInt($('.offer-carousel').data('items'));

            $('.offer-carousel').owlCarousel({
                loop: offerCount > 1, // loop only if more than 1 item
                margin: 10,
                autoplay: offerCount > 1,
                autoplayTimeout: 3000,
                autoplayHoverPause: true,
                smartSpeed: 700,
                items: offerCount > 0 ? 3 : 1, // Always show 3 items layout
                responsive: {
                    0: {
                        items: 1
                    },
