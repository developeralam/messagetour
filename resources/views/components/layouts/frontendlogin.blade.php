                ...
                <ul class="flex gap-2 md:gap-3 lg:gap-4 items-center font-semibold text-gray-600">
                    ...
                    <li>
                        <a @click="$dispatch('openModel')"
                            class="relative px-2 md:px-1.5 lg:px-3 py-1.5 md:py-2 rounded-lg hover:bg-green-50 hover:cursor-pointer  hover:text-green-600 transition text-sm md:text-base lg:text-[15px] {{ request()->is('contact-us') ? 'text-green-600 font-bold bg-green-50' : '' }}">
                            Corporate Query
                        </a>
                    </li>
                </ul>
