...
new #[Layout('components.layouts.admin')] #[Title('Aminities')] class extends Component {
    ...
    {
        return Aminities::query()->with('actionBy')->whereNull('created_by')->latest()->paginate(20);
    }
