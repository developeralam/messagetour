...
new #[Layout('components.layouts.admin')] #[Title('Add Vehicle')] class extends Component {
    ...
    public function storeCar()
    {
        ...
        try {
            ...
            $this->success('Vehicle Added Successfully', redirectTo: '/admin/vehicle/list');
        } catch (\Throwable $th) {
            dd($th->getMessage());
        ...
        <div class="grid grid-cols-3 gap-2" x-cloak>
            ...
            <div class="col-span-1">
                <x-card>
                    ...
                    <x-slot:actions>
                        <x-button label="Vehicle List" link="/admin/vehicle/list" class="btn-sm" />
