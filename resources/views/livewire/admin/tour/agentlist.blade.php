...
new #[Layout('components.layouts.admin')] #[Title('Agent Tour List')] class extends Component {
    use WithPagination;
    use Toast;
    ...
    public function tours()
    {
        return Tour::query()
            ...
            ->whereHas('createdBy', fn($q) => $q->where('type', UserType::Agent))
...
<div>
    <x-header title="Agent Tour List" size="text-xl" separator class="bg-white px-2 pt-2">
