...
new #[Layout('components.layouts.admin')] #[Title('Update Tour')] class extends Component {
    ...
    public function mount($tour)
    {
        ...
        $this->validity = $tour->validity->format('Y-m-d');
        $this->member_range = $tour->member_range;
        $this->minimum_passenger = $tour->minimum_passenger;
        $this->description = $tour->description;
        $this->country_id = $tour->country_id;
        $this->divisions();
        $this->division_id = $tour->division_id;
        $this->districts();
        $this->district_id = $tour->district_id;
        $this->is_featured = $tour->is_featured;
        $this->type = $tour->type;
        $this->status = $tour->status;
        $this->regular_price = $tour->regular_price;
        $this->offer_price = $tour->offer_price;
        $this->library = $tour->images ?? collect();
    }
    ...
    public function updateTour()
    {
        ...
        try {
            ...
            $this->success('Tour Updated Successfully', redirectTo: '/admin/tour/list');
        } catch (\Throwable $th) {
