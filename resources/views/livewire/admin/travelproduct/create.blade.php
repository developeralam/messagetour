...
new #[Layout('components.layouts.admin')] #[Title('Add New Travel Product')] class extends Component {
    ...
    #[Rule('required')]
    public $status = TravelProductStatus::Active;
    ...
    public function storeTravelProduct()
    {
        ...
        try {
            ...
            $this->success('Travel Product Added Successfully', redirectTo: '/admin/travel-product/list');
        } catch (\Throwable $th) {
        ...
        <div class="grid grid-cols-3 gap-4 items-start">
                ...
                <x-card>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <x-input label="Regular Price" class="mb-4" wire:model="regular_price"
                            placeholder="Regular Price" type="number" required />
            ...
            <x-card class="col-span-1">
                ...
                <x-slot:actions>
                    ...
                    <x-button type="submit" label="Save Product" class="btn-primary btn-sm"
                        spinner="storeTravelProduct" />
                </x-slot:actions>
