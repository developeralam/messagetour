            ...
            <main class="lg:col-span-3">
                ...
                <div class="bg-white/70 backdrop-blur-lg rounded-2xl shadow-lg border border-green-100 overflow-hidden">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Profile page coming soon!</h3>
                        <p class="text-gray-500 mb-4">We're working on a comprehensive profile management system.</p>
