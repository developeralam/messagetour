...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-100 via-white to-green-200 py-10 px-2">
    <div class="w-full max-w-xl bg-white/95 backdrop-blur-2xl shadow-2xl rounded-3xl p-8 relative overflow-hidden border border-green-100">
        ...
        <div class="relative z-10">
            <div class="flex flex-col items-center mb-7">
                <div class="mb-2">
                    <img src="{{ $globalSettings->logo_link ?? '/logo.png' }}" alt="Logo" class="w-full h-20 object-contain">
                </div>
            ...
            <x-form x-data="{ show: false, showConfirm: false }" wire:submit="agentRegister">
                <div>
                    ...
                    <div class="relative">
                        <input id="name" type="text" placeholder="Enter your name"
                            class="w-full px-4 py-2 border border-gray-400 rounded-xl focus:outline-none transition shadow-sm" wire:model="name"
                            required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" type="email" placeholder="Enter your email"
                            class="w-full px-4 py-2 border border-gray-400 rounded-xl focus:outline-none transition shadow-sm" wire:model="email"
                            required>
                        <span class="absolute right-3 top-2.5 text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input :type="show ? 'text' : 'password'" id="password" placeholder="Create a password"
                            class="w-full px-4 py-2 border border-gray-400 rounded-xl focus:outline-none transition shadow-sm" wire:model="password"
                            required>
                        <button type="button" class="absolute right-3 top-2 text-gray-400 focus:outline-none" @click="show = !show" tabindex="-1">
                ...
                <div>
                    <label class="block text-green-700 text-sm font-semibold mb-1" for="confirmation_password">Confirm
                        Password</label>
                    <div class="relative">
                        <input :type="showConfirm ? 'text' : 'password'" id="confirmation_password" placeholder="Confirm your password"
                        ...
                        <button type="button" class="absolute right-3 top-2 text-gray-400 focus:outline-none" @click="showConfirm = !showConfirm"
                            tabindex="-1">
                            <svg x-show="!showConfirm" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm7.5 0a9.003 9.003 0 01-17.978 0A9.003 9.003 0 0121.5 12z" />
                            </svg>
                ...
                <div>
                    <label class="block text-green-700 text-sm font-semibold mb-1" for="agent_type">Business
                        Type</label>
                    <x-choices class="custom-select-field w-full" wire:model="agent_type" :options="$businessTypes" placeholder="Select Business Type"
                        single />
                </div>
