...
new #[Layout('components.layouts.partner')] #[Title('Update Car')] class extends Component {
    ...
    public function storeCar()
    {
        ...
        try {
            ...
            $this->success('Vehicle Update Successfully', redirectTo: '/partner/vehicle/list');
        } catch (\Throwable $th) {
            ...
            <div class="col-span-1">
                <x-card>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        @if ($car != CarStatus::Pending)
                            <x-choices label="Status" :options="collect($carStatus)
                    ...
                    <x-slot:actions>
                        <x-button label="Car List" link="/partner/vehicle/list" class="btn-sm" />
