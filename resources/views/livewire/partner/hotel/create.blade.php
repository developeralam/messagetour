...
new #[Layout('components.layouts.partner')] #[Title('Add New Hotel')] class extends Component {
    ...
    public function storeHotel()
    {
        ...
        try {
            ...
            $this->success('Hotel Added Successfully', redirectTo: '/partner/hotel/list');
        } catch (\Throwable $th) {
...
<div>
    ...
    @endpush
    <x-header title="Add New Hotel" size="text-xl" separator class="bg-white px-2 pt-2">
        <x-slot:actions>
