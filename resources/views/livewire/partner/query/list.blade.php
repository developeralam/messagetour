...
new #[Layout('components.layouts.partner')] #[Title('Corporate Query List')] class extends Component {
        ...
        <x-table :headers="$headers" :rows="$queries" :sort-by="$sortBy" with-pagination>
            ...
            @scope('actions', $query)
                <div class="flex items-center gap-1">
                    ...
                    <x-button icon="s-pencil-square" link="/partner/corporate-query/{{ $query['id'] }}/edit"
                        class="btn-action btn-primary" />
                    <x-button icon="fas.print" external link="/partner/corporate-query/{{ $query['id'] }}"
