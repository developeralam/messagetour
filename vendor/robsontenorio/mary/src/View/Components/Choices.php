                    ...
                    >
                        ...
                        <div
                            ...
                            {{
                                $attributes->except(['wire:model', 'wire:model.live'])->class([
                                    "select select-bordered select-primary w-full h-fit pe-16 pb-1 inline-block cursor-pointer relative flex-1",
                        ...
                        >
                            ...
                            @if (!$compact && $attributes->has('placeholder'))
                                <span @class(["absolute inset-0 mt-1 text-sm me-8 truncate text-base text-gray-400 pointer-events-none", $icon ? "ms-10" : "ms-4"]) x-show="isSelectionEmpty && !focused">
