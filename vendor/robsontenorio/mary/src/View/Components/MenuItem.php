...
class MenuItem extends Component
{
    ...
    public function render(): View|Closure|string
    {
        ...
        return <<<'HTML'
                @aware(['activateByRoute' => false, 'activeBgColor' => 'bg-sidebar-active'])

                <li>
                    <a
                        {{
                            $attributes->class([
                                "my-[5px] hover:text-inherit whitespace-nowrap",
                                "text-black $activeBgColor" => ($active || ($activateByRoute && $routeMatches()))
                            ])
                        }}
                    ...
                    >
                        ...
                        <span class="mary-hideable whitespace-nowrap truncate text-xs">
                            @if($title)
                                {{ $title }}
